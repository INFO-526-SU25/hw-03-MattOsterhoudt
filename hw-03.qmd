...
mutate(response_value = case_when(
  ...
  response_value = factor(response_value, levels = c("Strongly disagree", "Somewhat agree", "Neither agree nor disagree",
                                                    "Somewhat disagree", "Strongly Agree"), ordered = TRUE)
 )
view (percent_data)
